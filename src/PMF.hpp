...
class PMF
{
    ...
    public :
		...
		void AddBirthPoint(T_REAL, T_REAL, T_REAL, T_REAL, EdgePoints<T_REAL> *);
		void UpdatePointVelocity(long, T_REAL, T_REAL, EdgePoints<T_REAL> *);
		void RemoveBirthPoint(long, T_REAL, T_REAL, EdgePoints<T_REAL> *);
